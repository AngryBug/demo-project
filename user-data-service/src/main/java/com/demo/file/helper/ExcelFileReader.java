...
public class ExcelFileReader {
	...
	public static void main(String...strings) throws IOException{
		...
		FileInputModel fileModel = FileResourceUtility.getFileDetails(ApplicationConstant.ADDRESS_FILE_TYPE);
		System.out.println(fileModel);

		System.out.println(readExcel(fileModel, "10001005", false));
